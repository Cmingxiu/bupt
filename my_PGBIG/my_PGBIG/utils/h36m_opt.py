...
class Options:
    ...
    def _initial(self):
        ...
        self.parser.add_argument('--point_npy', type=str, default='point_npy', help='path to save npy of checkpoint') 
        ...
        self.parser.add_argument('--num_heads', type=int, default=4, help='number of attention heads')
        self.parser.add_argument('--hidden_feature', type=int, default=256, help='number of hidden features')
        ...
        self.parser.add_argument('--batch_size', type=int, default=8)  # 8 for multistage model
        self.parser.add_argument('--test_batch_size', type=int, default=8)  # 8 for multistage model
