...
class Options:
    ...
    def _initial(self):
        ...
        self.parser.add_argument('--ckpt', type=str, default='checkpoint/sotaofus/', help='path to save checkpoint')
        ...
        #                     Model options
        # ===============================================================
        self.parser.add_argument('--input_feature', type=int, default=69, help='size of each model layer')
